...
public class Recommended extends Fragment implements View.OnClickListener {
    ...
    private String allJob="https://www.hiringmirror.com/api/jobs.php";
    ...
    public void onCreateOptionsMenu(final Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnSearchClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             //   ((EditText)searchView.findViewById(android.support.v7.recyclerview.R.id.search_src_text)).setTextColor(Color.BLACK);
